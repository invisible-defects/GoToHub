...
### Вход и регистрация
При первом входе пользователю необходимо зарегистрироваться. Чтобы случайные пользователи не заполняли базу данных, в файле config.py можно настроить пароль для входа. Для администрации или родителя необходимо ввести пароль, для простого пользователя - пароль пользователя, имя и фамилию. При последующем использовании бота (даже если бот был предварительно перезагружен) авторизация будет проходить автоматически.
...
#### Список пионеров
В этом разделе можно посмотреть список всех пионеров, прошедших регистрацию.  
![Список пионеров](screenshots/СписокПионеров.png)  
...
**Внимание! После раздела "Установка и настройка" есть еще информация о боте, так что если вы не собираетесь устанавливать бота прямо сейчас, пропустите этот раздел.** 
### Python
...
### Настройка бота
Скачайте этот репозиторий и извлеките файлы source и config в отдельную папку. Откройте файл config. В переменную token необходимо вставить токен бота, который дает @BotFather при регистрации бота. В переменные password, admin и parents можно вставить желаемые пароли пользователя, администратора и родителя соотвественно. Когда все выше описанное будет сделано, запустите source. Пока этот код запущен, бот будет работать.  
 

Если у вас остались вопросы, связаться со мной можно:  
