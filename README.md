...
Последним этапом является создание ключей команд, по которым будет проходить авторизация. Ключи команд имеют те же ограничения, что и названия квестов: одно слово на латинице. Использовать цифры в названиях команд нежелательно.
